...
const Payment = ({ route }) => {
    ...
    const month_of_payment = today.getMonth() + 1;
    const year_of_payment_month = today.getFullYear();
    ...
    const [formData, setFormData] = useState({
      ...
      year_of_payment_month: year_of_payment_month,
      amount: amount
  });
    ...
    const handleCreatePayment = async () => {
        ...
        try {
          const response = await fetch(`${API_BASE_URL}/notification/payment-gateway/`, {
            method: 'POST',
            headers: {
            ...
            <View style={styles.content}>
                {isBkashCard1Visible && (
                    <View style={styles.bkashCard}>
                        <Image source={require('../../../assets/gate1.png')} style={styles.logo} />
                        <View style={styles.textCard}>
                            <Text style={styles.text}>Merchant: TaxLiability.com</Text>
                            <Text style={styles.text}>Month: {month_of_payment} - {year_of_payment_month}</Text>
                        ...
                        <View style={styles.textInputCard}>
                            ...
                            <View style={styles.buttonsContainer2}>
                                <TouchableOpacity style={styles.button2} onPress={handlePin} >
                                  <Image source={require('../../../assets/btn2_logo.png')} style={styles.buttonImage} />
                                </TouchableOpacity>
